"""
Django settings for finansas project.
...
INSTALLED_APPS = [
    ...
    # Local apps
    'finanzas.apps.FinanzasConfig',  # More explicit app configuration
]
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'Finansas API',
    'DESCRIPTION': 'Financial Management API - Manage your accounts, transactions, budgets, debts, and financial goals',
    'VERSION': '1.0.0',
